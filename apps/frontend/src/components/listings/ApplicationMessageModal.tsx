...
import { formatMessageDate, formatPrice } from '../../lib/format';
...
export function ApplicationMessageModal({ open, listing, prefix, onClose, onCopied }: Props) {
  ...
  async function submit() {
    ...
    const msg = buildActionMessage(
      prefix,
      listing.adresse,
      formatPrice(listing.prix).replace(' /mois', ''),
  ...
  return (
    ...
    >
      ...
      <div className="form-field">
        ...
        <SanitizedInput id="msg-date" kind="dateIso" maxLength={10} value={date} onChange={setDate} />
      </div>
      <div className="form-field">
